...
module.exports = ({ extension = '.jsx', folder = 'templates', globals = {}, plugins = [] } = {}) => {
        ...
        context.set('view', {
            render(jsx, data = {}) {
                res
                    ...
                    .send(`<!DOCTYPE html>${require(`${templateFolder}/${jsx}${extension}`)(Object.assign(Object.assign(Object.assign({}, templateFunctions), globals), data))}`);
            }
        });
        next();
    };
